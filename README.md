...
+ build a NJ tree and then a ML tree
+ root a tree
+ compare evolutionary models
+ use bootstrapping to assess confidence in nodes
+ plot trees
...
+ README file
+ Completed R markdown script
+ PNG of final tree

  ...all in your student directory by the due date.
